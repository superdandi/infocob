            ...
            <ul className="space-y-2">
              {navLinks.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-text-muted text-sm hover:text-brand transition-colors duration-200"
                  >
                    {link.label}
                  </Link>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-text-muted text-sm">
              <li className="flex items-center gap-2">
                ...
                <a href="mailto:dcobosm@gmail.com" className="hover:text-brand transition-colors">
                  dcobosm@gmail.com
                </a>
              </li>
              <li>
              ...
              <li className="text-text-muted/80">Talca, Región del Maule, Chile</li>
            </ul>
            <div className="flex items-center gap-3 mt-4">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="p-2 rounded-lg bg-white/5 hover:bg-brand/10 text-text-muted hover:text-brand transition-all"
              >
              ...
              <a
                href="https://github.com/superdandi"
                target="_blank"
                rel="noopener noreferrer"
                className="p-2 rounded-lg bg-white/5 hover:bg-brand/10 text-text-muted hover:text-brand transition-all"
              >
